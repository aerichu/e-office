    ...
    <div class="content" id="content">
        <div class="container mt-5">
            <div class="form-container">
                ...
                <form action="<?= base_url('home/aksi_t_alumni') ?>" method="POST" enctype="multipart/form-data">                    
                    <!-- File Upload -->
                    ...
                    <!-- Nama -->
                    <div class="form-group">
                        <label for="tanggal_surat">NIS Alumni</label>
                        <input type="text" class="form-control" id="nis_alumni" name="nis_alumni" required>
                    </div>

                    <!-- Tahun Lulus -->
                    <div class="form-group">
                        <label for="tanggal_surat">Tahun Lulus</label>
                        <input type="date" class="form-control" id="tahun_lulus" name="tahun_lulus" required>
                    </div>

                    <!-- Jurusan -->
                    <div class="form-group">
                        <label for="tanggal_surat">Jurusan</label>
                        <input type="text" class="form-control" id="jurusan" name="jurusan" required>
                    </div>

                    <!-- IPK -->
                    <div class="form-group">
                        <label for="tanggal_surat">IPK</label>
